...
stream: examples/stream/stream.cpp examples/stream/params.cpp examples/stream/audio.cpp examples/stream/utils.cpp $(SRC_COMMON) $(SRC_COMMON_SDL) $(WHISPER_OBJ)
	$(CXX) $(CXXFLAGS) examples/stream/stream.cpp examples/stream/params.cpp examples/stream/audio.cpp  examples/stream/utils.cpp $(SRC_COMMON) $(SRC_COMMON_SDL) $(WHISPER_OBJ) -o stream $(CC_SDL) $(LDFLAGS)
